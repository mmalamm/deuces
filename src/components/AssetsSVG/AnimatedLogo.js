...
class AnimatedLogo extends Component {
  ...
  render() {
    const { height, width, cls } = this.props;
    return this.state.show ? (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        preserveAspectRatio="xMidYMid meet"
        version="1.0"
        viewBox="0 0 188.000000 292.000000"
        width={width}
        height={height}
        className={cls}
      ...
      >
        ...
        >
          <path
            className="logo logo-bigpath"
            d="M1087 2910 c-42 -13 -55 -27 -89 -94 -38 -77 -52 -93 -108 -121 -25
  ...
  22 -85 27 -37 4 -89 13 -116 21 -55 16 -78 16 -119 4z"
          />
          <path
            className="logo logo-earpath"
            d="M1535 1799 c-22 -11 -61 -41 -87 -66 l-47 -46 24 -23 c16 -15 25 -33
  ...
  169 -52 58 -173 76 -250 38z"
          />
          <path
            className="logo logo-smallpath"
            d="M1127 1402 c-10 -10 -17 -24 -17 -31 0 -6 -11 -34 -25 -61 -39 -78
  -27 -200 26 -256 31 -33 47 -30 104 17 81 67 83 78 20 148 -29 34 -46 63 -50
  88 -9 61 -25 113 -34 113 -4 0 -15 -8 -24 -18z"
          />
          <path
            className="logo logo-nosepath"
            d="M1561 1114 c18 -19 71 -53 116 -75 93 -46 124 -77 69 -71 -21 2 -40
  ...
  53 -58 72 -17 26 -49 48 -136 92 -114 57 -114 57 -80 22z"
          />
          <path
            className="logo logo-chinpath"
            d="M1067 653 c-4 -3 -7 -18 -7 -31 0 -30 -43 -107 -65 -116 -8 -3 -15
  ...
  -87 0 c-82 0 -93 3 -163 39 -41 21 -105 58 -141 82 -65 43 -88 51 -102 37z"
          />
          <path
            className="logo logo-neckpath"
            d="M874 473 c-41 -8 -63 -46 -84 -144 -26 -123 -49 -167 -105 -201 -51
