...
import {auth, googleAuthProvider, githubAuthProvider, database} from "../fire";
...
export const submitNewUserForm = formData => {
  ...
  const initUserEndpointURL = "https://us-central1-deuces-bovinecorvus.cloudfunctions.net/api/init_user";
